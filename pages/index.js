...
const CTA = () => {
	return (
		<div className='mt-8 text-center'>
			<button
				className='bg-primary sm:h-20 h-15 sm:w-48 text-white px-4 py-2 hover:shadow-lg uppercase rounded-full hover:drop-shadow-xl'
				onClick={() => {}}>
				Apply Now
			</button>
		</div>
...
export default function Home() {
					...
					<div className='sm:pt-35 pt-20 sm:w-2/3 mx-auto w-full '>
						...
						<div className='sm:flex justify-between py-10 sm:w-3/4 w-full mx-auto sm:mb-30'>
							<div className='w-auto'>
								<div className='flex'>
									<div
										className='w-[30px] h-[30px] bg-accent rounded-full flex 
 ...
 justify-center items-center'>
			...
			{/*End of Hero */}
			{/* start of calculator */}
			<div className='container py-2 px-2 sm:px-0 bottom-0 min-h-screen pb-7'>
				<>
					<div className='flex'>
						...
						<ol className='relative border-l border-primary container-sm '>
							<li className='mb-10 ml-6'>
								...
								<p className='mb-4 text-base font-normal text-gray-500'>
									You will need to provide your basic
									information
								</p>
				...
				{/* End of How it works */}
				{/* Our Partners */}{' '}
				<Subheading>Some of Our Partners</Subheading>
